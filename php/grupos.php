...
<main>
  <div class="jumbotron jumbotron-fluid bg-azul-logo text-warning mb-0">
    <div class="container text-center">
      <h1 class="display-3 font-weight-bold">GRUPOS</h1>
      <p class="lead font-weight-bold font-italic">Ensinar, no sentido restrito,
        é fazer um futuro melhor para cada aluno; no sentido lato, é garantir a
        perpetuação do progresso da humanidade!</p>
    </div>
  </div>
