    ...
    <div class="py-5">
      <div class="row justify-content-center">
        <div class="col-10">
          ...
          <div class="">
            <h3>Criar oferta de aula</h3>
          </div>

          <div class="">
            <form class="p-3 border" action="includes/create-offer.inc.php" method="POST">
              ...
              <div class="form-row ">
                <div class="form-group col">
                  ...
                  <select id="input-materia" name="mate_id" class="form-control">
                    ...
                    <option value="19"> Sistemas Operacionais </option>
                    ...
                    <div class="form-row align-items-center justify-content-between mt-2">
                      ...
                      <div class="col-auto p-0">
                        ...
                        <div class="input-group  ">
                          <input type="text" class="form-control" name="hroferta_inicio" placeholder="14:45" >
                          <!-- colocar type="time"  se quiser que fique no formato de horas ou colocar timepicker na class-->
                          <!-- <input type="time" class="form-control" name="hroferta_inicio" placeholder="14:45" required> -->
                        </div>
                      ...
                      <div class="col-auto p-0">
                        ...
                        <div class="input-group  ">
                          <input type="text" class="form-control" name="hroferta_fim" placeholder="14:45" >
                          <!-- colocar type="time"  se quiser que fique no formato de horas ou colocar timepicker na class-->
                          <!-- <input type="time" class="form-control" name="hroferta_fim" placeholder="14:45" required> -->
                        </div>
...
*/                    ?>
              ...
              <div class="form-row mt-3">
                ...
                <div class="form-group col">
                  ...
                  <input type="text" class="form-control" name="ofertaul_nome" placeholder="Insira o nome da aula" required>
                </div>

                <div class="form-group col">
                  <label for="input-local">Local</label>
                  <input type="text" class="form-control" name="hroferta_local" placeholder="A140" required>
                </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col">
                  ...
                  <textarea class="form-control" name="ofertaul_descricao" rows="3" placeholder="Insira o conteúdo de estudo da aula" required></textarea>
                </div>
